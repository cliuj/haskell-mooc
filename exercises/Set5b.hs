...
treeSize :: Tree a -> Int
treeSize Empty = 0
treeSize (Node _ n n') = 1 + treeSize n + treeSize n'
...
set (step:steps) val (Node x l r) =
    case step of
        StepL -> Node x (set steps val l) r
        StepR -> Node x l (set steps val r)

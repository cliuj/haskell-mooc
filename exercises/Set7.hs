...
data State = Start | HasEggs | HasFlour | HasSugar | HasFlourAndSugar | Mixed | Error | Finished
  deriving (Eq,Show)
...
passwordAllowed p (ContainsSome s) = intersect p s /= []

...
data Person = PersonUndefined String Int
  deriving Show

-- fred is a person whose name is Fred and age is 90
fred :: Person
fred = PersonUndefined "Fred" 90

-- getName returns the name of the person
getName :: Person -> String
getName (PersonUndefined name _) = name

-- getAge returns the age of the person
getAge :: Person -> Int
getAge (PersonUndefined _ age) = age

-- setName takes a person and returns a new person with the name changed
setName :: String -> Person -> Person
setName name (PersonUndefined _ age) = PersonUndefined name age

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (PersonUndefined name _) = PersonUndefined name age
...
rgb (Invert color) = map invert $ rgb color
    where
        invert c = 1 - c
